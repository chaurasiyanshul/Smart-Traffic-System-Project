...
# going up
    ...
    cv2.line(frame,(220,250),(700,250),red_color,3) 
    cv2.putText(frame,("red  line"),(200,250),cv2.FONT_HERSHEY_COMPLEX,0.5,text_color, 1,cv2.LINE_AA)


    cv2.line(frame,(100,395),(926,395),blue_color,3)
    cv2.putText(frame,('blue line'),(100,395),cv2.FONT_HERSHEY_COMPLEX, 0.5, text_color, 1 , cv2.LINE_AA)
    ...
    if cv2.waitKey(0) & 0xFF == 27:  # Changed waitKey to 1 for smoother video display
        break
